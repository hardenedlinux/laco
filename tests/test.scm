...
(check "Let var naming" "let-var-naming")
...
(check "Hygienic free identifier" "hygiene-free-identifier")
(check "Hygienic template binding" "hygiene-template-binding")
(check "Hygienic swap! regression" "hygiene-swap-regression")
(check "Hygienic ellipsis independence" "hygiene-ellipsis-independence")
(check "Hygienic let-syntax global helper" "hygiene-let-syntax-global")
(check "Hygienic control integration" "hygiene-integration-control")
