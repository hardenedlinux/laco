  ...
  (match expr
    ...
    (($ letfun/k ($ bind-special-form/k _ var value body))
     (parameterize ((current-def (id-name var)))
       (bind-special-form/k-value-set! expr (tco value))
       (bind-special-form/k-body-set! expr (tco body))
       expr))
    ((? bind-special-form/k?)
     (bind-special-form/k-value-set! expr (tco (bind-special-form/k-value expr)))
